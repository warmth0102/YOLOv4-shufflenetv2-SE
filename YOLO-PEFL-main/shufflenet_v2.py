...
class ShuffleBlock(nn.Module):
  def __init__(self, in_c, out_c, downsample=False, is_se=False):
...
class ShuffleNetV2(nn.Module):
  def __init__(self, input_size=416, net_type=1):
    ...
    self.stage2 = nn.Sequential(*self.stage2) # 52 * 52 * 116
...
def shufflenet_v2(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        state_dict = torch.load('./model_data/shufflenetv2_x1-5666bf0f80.pth')
